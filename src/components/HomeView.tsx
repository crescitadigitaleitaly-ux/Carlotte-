    ...
    <div className="space-y-24">
        ...
        <div className="space-y-6">
          ...
          <div className="pt-4 grid grid-cols-2 gap-4 border-t border-ink-black/15 font-oswald">
            <div>
              ...
              <span className="text-[10px] uppercase tracking-widest text-secondary font-semibold block mt-1">{t.acts[lang]}</span>
            </div>
            <div>
              <span className="text-ink-black text-3xl font-black block font-anton">100%</span>
              <span className="text-[10px] uppercase tracking-widest text-[#5e5e5e] font-semibold block mt-1">{t.localIngredients[lang]}</span>
            </div>
          </div>
          <div className="pt-4">
            <button
                ...
                <div className="p-6 space-y-3">
                  ...
                  {isSelected && (
                    <div className="pt-4 border-t-2 border-ink-black bg-[#F8F5EE] -mx-6 -mb-6 p-6 space-y-4">
                      <div>
                        <strong className="font-oswald uppercase tracking-widest text-accent-vermilion text-[10px] font-black block mb-1">{t.culinaryPrep[lang]}</strong>
                      ...
                      <div className="pt-3 border-t border-ink-black/15 flex items-center justify-between gap-4">
                        <div>
                          <strong className="font-oswald uppercase tracking-widest text-[#5e5e5e] text-[10px] font-black block mb-0.5">{t.sommelierFlight[lang]}</strong>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-0 border-2 border-ink-black shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] bg-surface-cream">
        ...
        <div className="p-8 space-y-4">
          ...
          <h3 className="font-anton text-xl uppercase text-ink-black tracking-tight font-black">{t.byInvitation[lang]}</h3>
          <p className="font-serif text-secondary text-sm leading-relaxed">
